<section class="contact" id="contact">
	<div class="text">
		...
		<p class="info">
			<i class="fa-solid fa-phone" aria-label="phone" />
			<span>316-871-6128</span>
		</p>
		<p class="info" aria-label="email">
			<i class="fa-solid fa-envelope" aria-label="phone" />
			<span>huynhlbg@mail.uc.edu</span>
		</p>
	</div>
	<div>
		<form class="form" name="contact-form-svelte" action="/" method="POST" data-netlify="true">
			<!-- To use Netlify form -->
			<input type="hidden" name="form-name" value="contact-form-svelte" />
