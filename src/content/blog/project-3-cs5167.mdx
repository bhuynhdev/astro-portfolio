...
cover: ../../assets/classroom-of-the-future.jpg
---
...
<video src="/project-3-cs5167/project_3_video.mp4" controls="controls" class="w-[95%] md:max-w-4xl" type="video/mp4" />
...
**Storyboard**
![](/project-3-cs5167/sketch-storyboard-prof-create-quiz.jpg)
In this scenario, the Professor plans their lecture at home --> Then they incorporate a Canvas quiz to make their inclass activities more engaging by using the search panel on the right, and dragging the Canvas Quiz element onto the main content area. A popup appears on the right for them too choose the specific quiz --> Then at lecture time, they presents the quiz in class.
...
The easy-to-use and easy-to-control light and volume settings can help professors create a more immersive lecture experience, knowing that they can use these equipment to their advantage instead of fighting them


**Storyboard**

![](/project-3-cs5167/sketch-storyboard-prof-use-room-control.jpg)
In this scenario, the Professor plans to display a video and intends to dim the light for a more themematic experience --> Professor goes to the control interface embeded on the smart table at the Professor station --> Professor moves the Light control to the left to decrease brightness, and move the Volume control to the right to increase sound --> The classroom is dimmed and the speakers are working at high power
...
![](/project-3-cs5167/classroom-photo-student-discussion.jpg)
...
Students from the same group benefit from *group screen share* feature. The touch table capabilities also mean that students have a creative canvas on which they can organize notes and contents around to make group more collaborative and enjoyable.
...
![](/project-3-cs5167/figma-student-note-taking.png)

From their touch tables, students can take note directly onto the Professor's lectures using the touch pen and the digital pen color toolbar on the right
...
## Advanced Interactions - touch, mid-air, speech, and AR (A-level goals)

### Multi-touch, mid-air gestures, and speech control

#### Multi-touch gesture

We often see students want to emphasize a certain portion of their lecture content, or want to zoom in on certain images for closer inspection, or just general zoom for better viewing. Therefore, we designed **two finger multi-touch zoom** feature.

![](/project-3-cs5167/sketch-storyboard-multitouch.png)
This scenario shows a common occurrence in large classrooms where students struggle to see the content displayed on a projector. Here, the student uses their touch display to zoom in on content being projected. The storyboard shows this motion of using one hand to pinch and zoom in on content displayed on their touch display. The final panel shows the outcome of this motion.

#### Voice control

We recognize that voice is an amazing tool to speed up mundane multi-step activities; a smart voice system can read the voice command and perform multi steps of actions for the users. Therefore, we designed the **share voice commands**. If the student says "Share" with the receiver name, the voice command can automatically detect the content current in use --> Search the list of friend for the name --> Make a send request on behalf

![](/project-3-cs5167/sketch-storyboard-voice.png)
In the above scenario, we have a classroom where students are able to work on a class assignment in a collaborative manner. The storyboard shows an example of sharing content through voice commands. Similar to the 'AirDrop' feature used in Apple devices, the student uses a share voice command (i.e. "Share to Johnny"), a pop-up window shows on the receiving student's touch display. Here, they will have the option to either accept or decline the shared content.   

#### Mid-air gesture

We designed the **grab and throw** mid-air gesture to allow students to quickly act upon notes that they really like. Often, when taking notes from professor's content or a peer's content sharing, things might go too fast that the students won't be able to capture in time. Grab and Throw allows students to wave their hand at the projector, _grab_ the on-display content into their hand, and _throw_ it onto their personal touch table canvas.

![](/project-3-cs5167/sketch-storyboard-midair.png)

This storyboard scenario involves AR-based hand gestures in combination with the student's touch display. Here, we have a student watching a professor's presentation that is being projected. The student will take their hand and reach as if they wanted to grab the presentation from mid-air. The student will then use that "grabbing" motion and "throw" the content onto their touch display as if they had it in their hand. This will allow them to take notes directly onto the presentation for their own use. 

### Augmented reality

If every person in the class is equipped with light-weight AR technology, that means everyone now have another dimension to share as well as consume content, aside from the normal 2D dimension of screens and projectors. This have some exciting uses in classroom:
- 3D modelling is made more easily understandable and interactive, as students can interract with the 3-dimensional-ness of the model in real-time and not confined to 2D imagination
- An extra dimension for organization. Now students can set up a comfortable working station with notes and resources organized in mid-air, leaving more space for the import content such as the note they are taking
- Personalization of information: One main usage of AR is additional information aside from the main content. Since each student has AR glasses, they can now view additional information about the lecture that can be tailored to their specific learning (likely through the usuage of an AI system), such as hints on a specific problem, or on how this new content connects with the student's previous note, or doing a real-time "Google" to immediately explain hard-to-grasp concept without waiting for the Professor's response.

From these findings, we designed our interfaces through hybrid sketches and storyboard as below


#### AR designs - Hybrid sketches
<div class="grid gap-6 grid-cols-1 md:grid-cols-2">

![](/project-3-cs5167/class_view_ar_hybrid_sketch.png)

Display screen is AR-capable to enable student to view extra relevant personalized information, such as hints or peers' answers. It is possble that each student's hint is different, as the **hints can be tailored** to their learning progress and capabilities. Different students also want to view different kinds of statistics, so having AR displays this kind of additional information without affecting others' view is a huge benefit.

![](/project-3-cs5167/desk_view_hybrid_sketch.png)

Using AR technology, students now have **another dimension to organize** their notes aside from the usual real-estate of the touch table. The hybrid sketch shows a student's note standing in mid-air (and possible even around them) in order to help students maximize their productivity
