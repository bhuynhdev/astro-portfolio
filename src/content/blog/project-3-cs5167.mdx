...
Professor's whiteboard is now interactive and directly drawable and erasable

![](/project-3-cs5167/class_view_ar_hybrid_sketch.png)
Professor display screen is also AR-capable to enable student to view extra relevant personalized information

![](/project-3-cs5167/professor_view_hybrid_sketch.png)
Class control system with AR information about real-time status of the class
