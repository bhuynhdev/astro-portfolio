...
cover: ../../assets/lego-g094009400.jpg
---
import { Image } from "astro:assets"
import enedDemoGif from "../../assets/ened-simulation-demo.gif"
...
![Graphs with rectangles and circles](../../assets/ened-matplotlib.png)
...
<div>
	<Image src={enedDemoGif} alt="Demonstration GIF" width="450" loading="lazy" />
</div>
